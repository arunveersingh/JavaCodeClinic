...
public class Patient {
    ...
    // ?????????????????????????????????????????????????????????????????????????????????????????
    // Problem 1: Patient is a simple java POJO and having methods in make it look cluttered.
    // Even in real world it's not patient's responsibility to remember whether it is
    // due for checkup or not. System/Object responsible for scheduling should be responsible for
    // it.
    // ?????????????????????????????????????????????????????????????????????????????????????????
